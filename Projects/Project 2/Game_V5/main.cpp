 ...
 * Purpose: Version 5 of Dr. Nim Game
 */
...
//Function Prototypes
void Sort(int array[], vector<int>);        //Bubble Sort
void Display(int array[], vector<int>);     //Display Function
int search(int array[], vector<int>, vector<int>);   //Binary Search
    ...
    do{
        ...
        switch(choice){
            ...
            case '2':{
                ...
                const int SIZE=5;
                vector<int> array[SIZE]={}; //Number of Marbles for Game  
                int srchNum=0;  //Number Selected for Guess Game
                vector<int> results;    //To hold Search results
                vector<char> ans;   //Answer to play again
...
void Sort(int *array,vector<int> SIZE){
bool swap;
int temp;
do{
    swap=false;
...
int search(int array[],vector<int> SIZE,vector<int> srchNum){  
    int first=0,
        last=SIZE.size()-1,
        middle,
        position=-1;
...
void Display(int *array,vector<int> SIZE){
